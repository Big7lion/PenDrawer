...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//NRF24L01寄存器操作命令
#define READ_24L01REG        0x00  //读配置寄存器,低5位为寄存器地址
#define WRITE_24L01REG       0x20  //写配置寄存器,低5位为寄存器地址
...
#define NRF24L01_CE(HorL)   HAL_GPIO_WritePin(NRF24L01_CE_GPIO_Port,NRF24L01_CE_Pin,(GPIO_PinState)(HorL)) //24L01片选信号
#define NRF24L01_CSN(HorL)  HAL_GPIO_WritePin(NRF24L01_CS_GPIO_Port,NRF24L01_CS_Pin,(GPIO_PinState)(HorL)) //SPI片选信号
#define NRF24L01_IRQ        HAL_GPIO_ReadPin(NRF24L01_INT_GPIO_Port,NRF24L01_INT_Pin)  //IRQ主机数据输入
//24L01发送接收数据宽度定义
