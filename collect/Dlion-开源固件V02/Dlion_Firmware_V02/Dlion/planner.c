...
float max_feedrate[4]={200, 200, 4, 45} ; // set the max speeds
float axis_steps_per_unit[4]={80,80,800,94.4962144};
unsigned long max_acceleration_units_per_sq_second[4]={3000,3000,100,3000} ; // Use M201 to override by software
unsigned long axis_steps_per_sqr_second[NUM_AXIS]={3000*80,3000*80,100*800,3000*94.4962144};
