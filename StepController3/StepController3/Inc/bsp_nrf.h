...
#define NRF24L01_CE(HorL)   HAL_GPIO_WritePin(NRF_CE_GPIO_Port,NRF_CE_Pin,(GPIO_PinState)(HorL)) //24L01片选信号
#define NRF24L01_CSN(HorL)  HAL_GPIO_WritePin(NRF_CSN_GPIO_Port,NRF_CSN_Pin,(GPIO_PinState)(HorL)) //SPI片选信号
